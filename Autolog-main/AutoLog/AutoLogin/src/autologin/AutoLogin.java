...
public class AutoLogin {
    ...
    public static void main(String isikukood) {
        ...
        WebElement journalsBtn = driver.findElement(By.xpath("/html/body/div/md-content/md-sidenav/div/ul/li[7]/menu-toggle/button/div[1]"));
        journalsBtn.click();
        
        WebElement journalBtn = driver.findElement(By.xpath("//*[@id=\"docs-menu-main.menu.myStudyInformation.label\"]/li[1]/menu-link/a"));
        journalBtn.click();
